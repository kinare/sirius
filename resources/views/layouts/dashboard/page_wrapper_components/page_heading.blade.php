    ...
    <div class="col-sm-8">
        <div class="title-action">
            ...
            <div class="btn-group hidden-xs" role="group" aria-label="leave">
                <button type="button"  class="btn btn-success btn-sm"  @click="swapComponent('exams')"><i class="fa fa-file-text"></i> Exam</button>
                <button type="button"  class="btn btn-danger btn-sm"   @click="timeTable()"><i class="fa fa-file-pdf-o"></i> &nbsp; Timetable</button>
                <button type="button"  class="btn btn-success btn-sm"   @click="examResults()"><i class="fa fa-file-pdf-o"></i> &nbsp; exam results</button>
            </div>


                <div class="btn-group btn-group-justified visible-xs" role="group" aria-label="leave">
                    <div class="btn-group">
                        <button type="button"  class="btn btn-success btn-lg"  @click="swapComponent('exams')"><i class="fa fa-file-text"></i> Exam</button>
                    </div>
                    <div class="btn-group">
                        <button type="button"  class="btn btn-danger btn-lg"  @click="timeTable()"><i class="fa fa-file-pdf-o"></i> &nbsp Timetable</button>
                    </div>
                </div>
